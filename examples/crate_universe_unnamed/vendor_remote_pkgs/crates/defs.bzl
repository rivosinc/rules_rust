...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "tracing-subscriber": "@crates_vendor_pkgs__tracing-subscriber-0.3.16//:tracing_subscriber",
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__futures-channel-0.3.25",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.futures-channel-0.3.25.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_pkgs__futures-core-0.3.25",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.futures-core-0.3.25.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_pkgs__futures-sink-0.3.25",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.futures-sink-0.3.25.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_pkgs__futures-task-0.3.25",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.futures-task-0.3.25.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_pkgs__futures-util-0.3.25",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.futures-util-0.3.25.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_pkgs__h2-0.3.15",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.h2-0.3.15.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.hermit-abi-0.1.19.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.http-0.2.8.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.instant-0.1.12.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_pkgs__itoa-1.0.4",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.itoa-1.0.4.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__libc-0.2.137",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.libc-0.2.137.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.mime-0.3.16.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.mio-0.7.14.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.miow-0.3.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.ntapi-0.3.7.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__once_cell-1.16.0",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.once_cell-1.16.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.parking_lot-0.11.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.parking_lot_core-0.8.5.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__proc-macro2-1.0.47",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.proc-macro2-1.0.47.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_pkgs__quote-1.0.21",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.quote-1.0.21.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__ryu-1.0.11",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.ryu-1.0.11.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.signal-hook-registry-1.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.slab-0.4.7.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__socket2-0.4.7",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.socket2-0.4.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.sync_wrapper-0.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.thread_local-1.1.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.tokio-1.16.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.tokio-util-0.7.2.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__tracing-subscriber-0.3.16",
        sha256 = "a6176eae26dd70d0c919749377897b54a9276bd7061339665dd68777926b5a70",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/tracing-subscriber/0.3.16/download"],
        strip_prefix = "tracing-subscriber-0.3.16",
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.tracing-subscriber-0.3.16.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.try-lock-0.2.3.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_pkgs__unicode-ident-1.0.5",
        ...
        build_file = Label("@//vendor_remote_pkgs/crates:BUILD.unicode-ident-1.0.5.bazel"),
    )
